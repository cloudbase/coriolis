...
opts = [
    ...
    cfg.StrOpt(
        'cafile',
        default=None,
        help='The CA file used to validate openstack service API endpoints.',
    ),
    cfg.IntOpt(
    ...
    cfg.BoolOpt(
        'allow_untrusted', default=False, help='Allow untrusted SSL/TLS certificates.'
    ),
]
...
def create_trust(ctxt):
    ...
    session = ks_session.Session(auth=auth, verify=_get_verify_option())
