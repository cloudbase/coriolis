...
class BaseServiceFilterTestCase(test_base.CoriolisBaseTestCase):
    ...
    def test_is_service_acceptable(self):
        ...
        result = self.service_filter.is_service_acceptable(mock.sentinel.service)

        self.service_filter.rate_service.assert_called_once_with(mock.sentinel.service)
    ...
    def test_filter_services(self):
        ...
        self.service_filter.is_service_acceptable.side_effect = [True, False, True]

        result = self.service_filter.filter_services(
            [mock.sentinel.service1, mock.sentinel.service2, mock.sentinel.service3]
        )

        self.assertEqual(result, [mock.sentinel.service1, mock.sentinel.service3])
