...
class APITestCase(test_base.CoriolisBaseTestCase):
    ...
    def test_create(self):
        self.api.create('ctxt', 'host', 'binary', 'topic', 'mapped_regions', True)
    ...
    def test_delete(self):
        ...
        self.rpc_client_mock.delete_service.assert_called_once_with('ctxt', 'region_id')
    ...
    def test_get_service(self):
        ...
        self.rpc_client_mock.get_service.assert_called_once_with('ctxt', 'service_id')
