...
ARGS = {"ctxt": "mock_ctxt", "endpoint_id": "mock_endpoint_id"}
...
class EndpointResourcesAPITestCase(test_base.CoriolisBaseTestCase):
    ...
    def test_get_endpoint_instances(self):
        ...
        (
            self.endpoint_resources_api._rpc_client.get_endpoint_instances.assert_called_once_with
        )(
            *(ARGS.values()),
        ...
        self.assertEqual(
            (
                self.endpoint_resources_api._rpc_client.get_endpoint_instances.return_value
            ),
            result,
        )
    ...
    def test_get_endpoint_instance(self):
        ...
        (
            self.endpoint_resources_api._rpc_client.get_endpoint_instance.assert_called_once_with
        )(
            *(ARGS.values()),
            mock.sentinel.source_environment,
        ...
        self.assertEqual(
            (
                self.endpoint_resources_api._rpc_client.get_endpoint_instance.return_value
            ),
            result,
        )
    ...
    def test_get_endpoint_networks(self):
        result = self.endpoint_resources_api.get_endpoint_networks(
            **ARGS, env=mock.sentinel.env
        )
        (
            self.endpoint_resources_api._rpc_client.get_endpoint_networks.assert_called_once_with
        )(*(ARGS.values()), mock.sentinel.env)
        self.assertEqual(
            (
                self.endpoint_resources_api._rpc_client.get_endpoint_networks.return_value
            ),
            result,
        )
    ...
    def test_get_endpoint_storage(self):
        ...
        (
            self.endpoint_resources_api._rpc_client.get_endpoint_storage.assert_called_once_with
        )(*(ARGS.values()), mock.sentinel.env)
        self.assertEqual(
            (self.endpoint_resources_api._rpc_client.get_endpoint_storage.return_value),
            result,
        )
