...
class FactoryTestCase(test_base.CoriolisBaseTestCase):
    ...
    def test_get_available_providers(self, mock_conf, mock_load_class):
        ...
        with mock.patch.dict(
            'coriolis.providers.factory.PROVIDER_TYPE_MAP',
            {'type1': ProviderClass, 'type2': ProviderClass},
        ):
            expected_result = {mock.sentinel.platform: {'types': ['type1', 'type2']}}

            result = factory.get_available_providers()

            mock_load_class.assert_has_calls(
                [mock.call(mock_conf.providers[0]), mock.call(mock_conf.providers[1])]
            )
    ...
    def test_get_provider_found(self, mock_conf, mock_load_class):
        ...
        with mock.patch.dict(
            ...
            mock_load_class.assert_has_calls([mock.call(mock_conf.providers[0])])
