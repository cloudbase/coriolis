...
from coriolis.db.sqlalchemy import api, migration
...
class DatabaseSqlalchemyApiTestCase(test_base.CoriolisBaseTestCase):
    ...
    def test_get_facade_none(self, mock_EngineFacade):
        ...
        self.assertEqual(mock_EngineFacade.return_value, result)
    ...
    def test_get_facade(self, mock_EngineFacade):
        ...
        self.assertEqual(mock.sentinel.facade, result)
    ...
    def test_get_engine(self, mock_get_facade):
        ...
        self.assertEqual(mock_get_facade.return_value.get_engine.return_value, result)

    @mock.patch.object(api, 'get_facade')
    def test_get_session(self, mock_get_facade):
        result = api.get_session()

        self.assertEqual(mock_get_facade.return_value.get_session.return_value, result)
    ...
    def test_db_sync(self, mock_db_version, mock_db_sync):
        ...
        mock_db_sync.assert_called_once_with(mock.sentinel.engine, version=None)

    @mock.patch.object(migration, 'db_sync')
    @mock.patch.object(api, 'db_version')
    def test_db_sync_version(self, mock_db_version, mock_db_sync):
        ...
        mock_db_sync.assert_called_once_with(mock.sentinel.engine, version="002")

    @mock.patch.object(migration, 'db_sync')
    @mock.patch.object(api, 'db_version')
    def test_db_sync_version_no_current_version(self, mock_db_version, mock_db_sync):
        ...
        self.assertEqual(mock_db_sync.return_value, result)
        mock_db_version.assert_called_once_with(mock.sentinel.engine)
        mock_db_sync.assert_called_once_with(mock.sentinel.engine, version="001")
