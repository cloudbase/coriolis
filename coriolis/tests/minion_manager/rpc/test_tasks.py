...
class MinionManagerTaskEventMixinTestCase(test_base.CoriolisBaseTestCase):
    ...
    def test__conductor_client(self):
        with mock.patch(
            ...
            return_value=mock.MagicMock(spec=ConductorClient),
        ) as mock_Conductor_client:
            result = self.task._conductor_client

            self.assertEqual(result, mock_Conductor_client.return_value)
    ...
    def test__conductor_client_already_set(self):
        with mock.patch(
            ...
            self.task._conductor_client_instance = mock.MagicMock(spec=ConductorClient)

            result = self.task._conductor_client

            self.assertEqual(result, self.task._conductor_client_instance)
    ...
    def test__minion_manager_client(self):
        with mock.patch(
            ...
            return_value=mock.MagicMock(spec=MinionManagerClient),
        ) as mock_Minion_Manager_Client:
            result = self.task._minion_manager_client

            self.assertEqual(result, mock_Minion_Manager_Client.return_value)
    ...
    def test__minion_manager_client_already_set(self):
        with mock.patch(
            ...
            self.assertEqual(result, self.task._minion_manager_client_instance)
    ...
    def test__add_minion_pool_event(self, mock_add_minion_pool_event):
        ...
        mock_add_minion_pool_event.assert_called_once_with(
            mock.sentinel.context,
            mock.sentinel.minion_pool_id,
            tasks.constants.TASK_EVENT_INFO,
            mock.sentinel.message,
        )
    ...
    def test__get_minion_machine_not_found(self, mock_get_minion_machine):
        ...
        self.assertRaises(
            tasks.exception.NotFound,
            self.task._get_minion_machine,
            mock.sentinel.context,
    ...
    def test__set_minion_pool_status(self, mock_set_minion_pool_status):
        with mock.patch.object(
            tasks.minion_manager_utils, 'get_minion_pool_lock'
        ) as mock_get_minion_pool_lock:
    ...
    @mock.patch.object(tasks.MinionManagerTaskEventMixin, '_update_minion_machine')
    def test__set_minion_machine_power_status(self, mock_update_minion_machine):
...
class BaseReportMinionAllocationFailureForActionTaskTestCase(
    ...
    def setUp(self, mock_get_task_name):
        super(BaseReportMinionAllocationFailureForActionTaskTestCase, self).setUp()
    ...
    @mock.patch.object(MinionManagerClient, 'deallocate_minion_machines_for_action')
    def test_revert(
        self,
        mock_deallocate_minion_machines_for_action,
        mock_report_machine_allocation_failure,
    ):
        result = self.task.revert(mock.sentinel.context, mock.sentinel.flow_failures)
        self.assertIsNone(result)
        ...
        mock_report_machine_allocation_failure.assert_called_once_with(
            mock.sentinel.context, mock.sentinel.action_id, "No flow failures provided."
        )
...
class ReportMinionAllocationFailureForMigrationTaskTestCase(
    ...
    def setUp(self):
        super(ReportMinionAllocationFailureForMigrationTaskTestCase, self).setUp()
        self.action_id = mock.sentinel.action_id
        self.task = tasks.ReportMinionAllocationFailureForMigrationTask(self.action_id)

    def test_get_task_name(self):
        result = self.task._get_task_name(self.action_id)
        self.assertEqual(
            result, f"migration-{self.action_id}-minion-allocation-failure"
        )
...
class ReportMinionAllocationFailureForReplicaTaskTestCase(
    ...
    def setUp(self):
        super(ReportMinionAllocationFailureForReplicaTaskTestCase, self).setUp()
        self.action_id = mock.sentinel.action_id
        self.task = tasks.ReportMinionAllocationFailureForReplicaTask(self.action_id)

    def test_get_task_name(self):
        result = self.task._get_task_name(self.action_id)
        self.assertEqual(result, f"replica-{self.action_id}-minion-allocation-failure")
...
class BaseConfirmMinionAllocationForActionTaskTestCase(test_base.CoriolisBaseTestCase):
    @mock.patch.object(
        tasks._BaseConfirmMinionAllocationForActionTask, '__abstractmethods__', set()
    )
    @mock.patch.object(
    ...
    @mock.patch.object(tasks.MinionManagerTaskEventMixin, '_get_minion_machine')
    @mock.patch.object(
    ...
    def test_execute(self, mock_confirm_allocation, mock_get_minion_machine):
        ...
        mock_confirm_allocation.assert_called_once_with(
            mock.sentinel.context, mock.sentinel.action_id, expected_machine_allocations
        )
    ...
    def test_execute_no_machine_allocation(
        ...
        mock_get_minion_machine.return_value = self.minion_machine
        self.allocated_machine_id_mappings[mock.sentinel.instance_id] = {}
    ...
    def test_execute_with_exception_not_found(
        self, mock_get_minion_machine, mock_get_action_label, mock_confirm_allocation
    ):
        mock_get_minion_machine.return_value = self.minion_machine
    ...
    def test_execute_raises_exception_when_invalid_migration_state(
        self, mock_get_minion_machine, mock_confirm_allocation, mock_get_action_label
    ):
        mock_get_minion_machine.return_value = self.minion_machine
...
class ConfirmMinionAllocationForMigrationTaskTestCase(test_base.CoriolisBaseTestCase):
    def setUp(self):
        super(ConfirmMinionAllocationForMigrationTaskTestCase, self).setUp()
        self.action_id = mock.sentinel.action_id

        self.task = tasks.ConfirmMinionAllocationForMigrationTask(
            mock.sentinel.action_id, mock.sentinel.allocated_machine_id_mappings
        )
    ...
    def test_get_task_name(self):
        ...
        self.assertEqual(
            result, f"migration-{self.action_id}-minion-allocation-confirmation"
        )

    @mock.patch.object(ConductorClient, 'confirm_deployment_minions_allocation')
    def test__confirm_machine_allocation_for_action(
        ...
        result = self.task._confirm_machine_allocation_for_action(
            mock.sentinel.context, self.action_id, mock.sentinel.machine_allocations
        )
...
class ConfirmMinionAllocationForReplicaTaskTestCase(test_base.CoriolisBaseTestCase):
    def setUp(self):
        super(ConfirmMinionAllocationForReplicaTaskTestCase, self).setUp()
        self.task = tasks.ConfirmMinionAllocationForReplicaTask(
            mock.sentinel.action_id, mock.sentinel.allocate_machine_id_mappings
        )
    ...
    def test_get_task_name(self):
        ...
        self.assertEqual(
            result, f"replica-{mock.sentinel.action_id}-minion-allocation-confirmation"
        )

    @mock.patch.object(ConductorClient, 'confirm_transfer_minions_allocation')
    def test__confirm_machine_allocation_for_action(
...
class UpdateMinionPoolStatusTaskTestCase(test_base.CoriolisBaseTestCase):
    ...
    @mock.patch.object(tasks.MinionManagerTaskEventMixin, '_add_minion_pool_event')
    ...
    @mock.patch.object(tasks.MinionManagerTaskEventMixin, '_set_minion_pool_status')
    @mock.patch.object(tasks.db_api, 'get_minion_pool')
    def test_revert_no_minion_pool(
        self, mock_get_minion_pool, mock_set_minion_pool_status
    ):
...
class BaseMinionManangerTaskTestCase(test_base.CoriolisBaseTestCase):
    ...
    @mock.patch.object(tasks.BaseMinionManangerTask, '__abstractmethods__', set())
...
class ValidateMinionPoolOptionsTaskTestCase(test_base.CoriolisBaseTestCase):
    ...
    def setUp(self):
        ...
        self.task = tasks.ValidateMinionPoolOptionsTask(
            self.minion_pool_id, mock.sentinel.minion_machine_id, self.minion_pool_type
        )
...
class AllocateSharedPoolResourcesTaskTestCase(test_base.CoriolisBaseTestCase):
    ...
    def setUp(self):
        ...
        self.minion_pool_id = 'test_pool_id'
        self.minion_pool_type = tasks.constants.PROVIDER_PLATFORM_SOURCE
        self.task_info = {'pool_shared_resources': True}
    ...
    def test_execute(
        ...
        mock_execute.return_value = {'pool_shared_resources': {"resource1": "id1"}}
        ...
        self.assertEqual(result, {'pool_shared_resources': {"resource1": "id1"}})

        mock_get_minion_pool_lock.assert_called_with(self.minion_pool_id, external=True)
        mock_get_minion_pool.assert_called_once_with(
    ...
    @mock.patch.object(tasks.db_api, 'update_minion_pool')
    def test_revert(
        self, mock_update_minion_pool, mock_get_minion_pool_lock, mock_revert
    ):
        self.task_info = {}
        self.update_values = {'pool_shared_resources': None}
...
class DeallocateSharedPoolResourcesTaskTestCase(test_base.CoriolisBaseTestCase):
    ...
    @mock.patch.object(tasks.BaseMinionManangerTask, 'execute')
    def test_execute(
        self, mock_execute, mock_update_minion_pool, mock_add_minion_pool_event
    ):
        self.update_values = {
...
class AllocateMinionMachineTaskTestCase(test_base.CoriolisBaseTestCase):
    ...
    def test__get_task_name(self):
        result = self.task._get_task_name(self.minion_pool_id, self.minion_machine_id)
    ...
    @mock.patch.object(tasks.MinionManagerTaskEventMixin, '_add_minion_pool_event')
    @mock.patch.object(
        tasks.MinionManagerTaskEventMixin, '_set_minion_machine_allocation_status'
    )
    ...
    def test_execute(
        ...
        expected_updated_values = {
            ...
            'allocation_status': (tasks.constants.MINION_MACHINE_STATUS_IN_USE),
            'power_status': (tasks.constants.MINION_MACHINE_POWER_STATUS_POWERED_ON),
            'connection_info': 'test_connection_info',
            'provider_properties': 'test_provider_properties',
            'backup_writer_connection_info': ('test_backup_writer_connection_info'),
        ...
        mock_get_minion_machine.assert_called_once_with(
            mock.sentinel.context, self.minion_machine_id, raise_if_not_found=False
        )
...
class DeallocateMinionMachineTaskTestCase(test_base.CoriolisBaseTestCase):
    ...
    def setUp(self):
        ...
        self.task._deallocate_from_action = self.minion_machine.allocated_action
...
class HealthcheckMinionMachineTaskTestCase(test_base.CoriolisBaseTestCase):
    ...
    def setUp(self):
        ...
        self.task = tasks.HealthcheckMinionMachineTask(
            ...
            machine_status_on_success=(tasks.constants.MINION_MACHINE_STATUS_AVAILABLE),
        )
...
class MinionMachineHealtchcheckDeciderTestCase(test_base.CoriolisBaseTestCase):
    ...
    def setUp(self):
        ...
        self.task = tasks.MinionMachineHealtchcheckDecider(
            self.minion_pool_id, self.minion_machine_id, on_successful_healthcheck=True
        )
    ...
    def test_call_with_healthy_result(self):
        history = {self.healthcheck_task_name: {"healthy": True}}

        result = self.task.__call__(history)
        self.assertEqual(result, self.task._on_success)

    def test_call_with_unhealthy_result(self):
        history = {self.healthcheck_task_name: {"healthy": False}}
...
class PowerOnMinionMachineTaskTestCase(test_base.CoriolisBaseTestCase):
    ...
    def test_execute(
        ...
        mock_get_minion_machine.assert_called_once_with(
            mock.sentinel.context, self.minion_machine_id, raise_if_not_found=True
        )
    ...
    def test_execute_with_exception(
        ...
        mock_get_minion_machine.return_value = self.minion_machine
        mock_set_minion_machine_power_status.side_effect = exception.CoriolisException
