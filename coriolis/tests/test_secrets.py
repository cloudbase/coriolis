...
from coriolis import keystone, secrets
...
class SecretsTestCase(test_base.CoriolisBaseTestCase):
    ...
    def test_get_barbican_secret_payload(self, mock_client, mock_session):
        ...
        mock_barbican.secrets.get.assert_called_once_with(mock.sentinel.secret_ref)
    ...
    def test_get_secret_success(self, mock_get_payload):
        ...
        result = secrets.get_secret(mock.sentinel.ctxt, mock.sentinel.secret_ref)
    ...
    def test_get_secret_unauthorized(self, mock_get_payload):
        ...
        mock_get_payload.assert_called_with(mock_ctxt, mock.sentinel.secret_ref)
    ...
    def test_get_secret_raises_value_error(self, mock_get_payload):
        ...
        self.assertRaises(
            ValueError, secrets.get_secret, mock.sentinel.ctxt, mock.sentinel.secret_ref
        )
