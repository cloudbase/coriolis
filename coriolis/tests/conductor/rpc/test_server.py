...
class ConductorServerEndpointTestCase(test_base.CoriolisBaseTestCase):
    ...
    def test__get_reservation_type(self):
        ...
        self.assertEqual(
            ...
            server._get_reservation_type(
                standard_endpoint, constants.TRANSFER_SCENARIO_LIVE_MIGRATION
            ),
        )
        self.assertEqual(
        ...
        self.assertIsNone(
            server._get_reservation_type(standard_endpoint, "unknown_scenario")
        )
        self.assertIsNone(
    ...
    def test_create_instances_transfer(
        ...
        mock_create_reservation_for_transfer.assert_called_once_with(
            mock_transfer.return_value, mock.sentinel.destination_endpoint_id
        )
