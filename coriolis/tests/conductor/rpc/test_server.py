...
class ConductorServerEndpointTestCase(test_base.CoriolisBaseTestCase):
    ...
    @mock.patch.object(rpc_worker_client.WorkerClient, "from_service_definition")
    @mock.patch.object(server.ConductorServerEndpoint, "_scheduler_client")
    def test_get_all_diagnostics(
        self, mock_scheduler_client, mock_from_service_definition
    ):
        ...
        assert mock_scheduler_client.get_diagnostics.return_value in diagnostics
    ...
    def test_get_worker_service_rpc_for_specs(
        ...
        result = self.server._get_worker_service_rpc_for_specs(mock.sentinel.context)
    ...
    def test_check_delete_reservation_for_transfer_no_licensing_client(self):
        ...
        with self.assertLogs('coriolis.conductor.rpc.server', level=logging.WARNING):
            self.server._check_delete_reservation_for_transfer(transfer_action)

    def test_check_delete_reservation_for_transfer_delete_fails(self):
        transfer_action = mock.Mock()
        self._licensing_client.delete_reservation.side_effect = CoriolisTestException()
        with self.assertLogs('coriolis.conductor.rpc.server', level=logging.WARNING):
            self.server._check_delete_reservation_for_transfer(transfer_action)
        self._licensing_client.delete_reservation.assert_called_once_with(
            transfer_action.reservation_id
    ...
    def test_create_endpoint(
        ...
        self.assertEqual(mock_endpoint_model.return_value.name, mock.sentinel.name)
        self.assertEqual(
    ...
    def test_get_endpoint_instance(
        ...
        rpc_return_value = mock_get_worker_service_rpc_for_specs.return_value
        self.assertEqual(instance, rpc_return_value.get_endpoint_instance.return_value)
    ...
    def test_get_endpoint_destination_options(
        ...
        rpc_return_value = mock_get_worker_service_rpc_for_specs.return_value
        rpc_return_value.get_endpoint_destination_options.assert_called_once_with(
            mock.sentinel.context,
            mock_get_endpoint.return_value.type,
            mock_get_endpoint.return_value.connection_info,
            mock.sentinel.environment,
    ...
    def test_get_endpoint_networks(
        ...
        self.assertEqual(networks, rpc_return_value.get_endpoint_networks.return_value)
    ...
    def test_get_endpoint_inventory_csv(
        ...
        self.assertEqual(
            result, rpc_return_value.get_endpoint_inventory_csv.return_value
        )
    ...
    def test_validate_endpoint_target_environment(
        ...
        mock_get_worker_service_rpc_for_specs.return_value.validate_endpoint_target_environment.assert_called_once_with(
            mock.sentinel.context,
            mock_get_endpoint.return_value.type,
            mock.sentinel.target_env,
        )
    ...
    def test_validate_endpoint_source_environment(
        ...
        mock_get_worker_service_rpc_for_specs.return_value.validate_endpoint_source_environment.assert_called_once_with(
            mock.sentinel.context,
            mock_get_endpoint.return_value.type,
            mock.sentinel.source_env,
        )
    ...
    def test_get_available_providers(
        ...
        mock_service_definition.return_value.get_available_providers.assert_called_once_with(
            mock.sentinel.context
        )
        self.assertEqual(
            providers,
            mock_service_definition.return_value.get_available_providers.return_value,
        )

    @mock.patch.object(server.ConductorServerEndpoint, "_scheduler_client")
    @mock.patch.object(rpc_worker_client.WorkerClient, "from_service_definition")
    def test_get_provider_schemas(self, mock_service_definition, mock_scheduler_client):
        ...
        mock_service_definition.return_value.get_provider_schemas.assert_called_once_with(
            mock.sentinel.context,
            mock.sentinel.platform_name,
            mock.sentinel.provider_type,
        )
        self.assertEqual(
            provider_schemas,
            mock_service_definition.return_value.get_provider_schemas.return_value,
        )

    @mock.patch.object(models, "Task")
    @mock.patch.object(uuid, "uuid4", return_value="task_id")
    def test_create_task(self, mock_uuid4, mock_task_model):
    ...
    def test_get_task_origin(self, mock_get_endpoint):
        ...
        result = self.server._get_task_origin(mock.sentinel.context, action)
    ...
    def test_get_task_destination(self, mock_get_endpoint):
        ...
        result = self.server._get_task_destination(mock.sentinel.context, action)
    ...
    def test_get_worker_service_rpc_for_task(
        ...
        mock_scheduler_client.get_worker_service_for_task.assert_called_once_with(
            mock.sentinel.context,
    ...
    @mock.patch.object(server.ConductorServerEndpoint, "_set_tasks_execution_status")
    @mock.patch.object(
        server.ConductorServerEndpoint, "_get_worker_service_rpc_for_task"
    )
    @mock.patch.object(db_api, "set_task_status")
    @mock.patch.object(db_api, "get_endpoint")
    ...
    def test_begin_tasks(
        ...
        execution = mock.Mock(id=mock.sentinel.execution_id, tasks=[task])
        ...
        mock_get_task_destination.assert_called_once_with(mock_context, mock_action)
        ...
        (
            mock_get_worker_service_rpc_for_task.return_value.begin_task.assert_called_once_with
        )(
            mock_context,
    ...
    @mock.patch.object(server.ConductorServerEndpoint, "_cancel_tasks_execution")
    @mock.patch.object(
        server.ConductorServerEndpoint, "_get_worker_service_rpc_for_task"
    )
    @mock.patch.object(db_api, "set_task_status")
    ...
    def test_begin_tasks_begin_task_raises(
        ...
        execution = mock.Mock(id=mock.sentinel.execution_id, tasks=[task])
        (
            mock_get_worker_service_rpc_for_task.return_value.begin_task.side_effect
        ) = CoriolisTestException()
    ...
    def test_begin_tasks_no_newly_started_tasks(
        ...
        (
            mock_get_worker_service_rpc_for_task.return_value.begin_task.assert_not_called
        )()
    ...
    def test_delete_transfer_disks_invalid_state(
        self, mock_get_transfer, mock_check_transfer_running, mock_create_task
    ):
    ...
    def test_check_execution_tasks_sanity(
        ...
        def convert_to_task(task_config):
            ...
            instance_task.instance = task_config.get("instance", mock.sentinel.instance)
        ...
        if not expected_result:
            self.server._check_execution_tasks_sanity(execution, initial_task_info)
        else:
            exception_mappings = {
    ...
    @mock.patch.object(server.ConductorServerEndpoint, "_get_transfer_tasks_execution")
    @mock.patch.object(server.ConductorServerEndpoint, "_begin_tasks")
    @mock.patch.object(server.ConductorServerEndpoint, "_set_tasks_execution_status")
    @mock.patch.object(server.ConductorServerEndpoint, "_minion_manager_client")
    @mock.patch.object(db_api, "add_transfer_tasks_execution")
    @mock.patch.object(db_api, "update_transfer_action_info_for_instance")
    @mock.patch.object(server.ConductorServerEndpoint, "_check_execution_tasks_sanity")
    @mock.patch.object(server.ConductorServerEndpoint, "_create_task")
    @mock.patch.object(uuid, "uuid4")
    @mock.patch.object(models, "TasksExecution")
    @mock.patch.object(server.ConductorServerEndpoint, "_check_minion_pools_for_action")
    @mock.patch.object(
        server.ConductorServerEndpoint, "_check_transfer_running_executions"
    )
    @mock.patch.object(
        server.ConductorServerEndpoint, "_check_reservation_for_transfer"
    )
    @mock.patch.object(server.ConductorServerEndpoint, "_get_transfer")
    ...
    def test_execute_transfer_tasks(
        ...
        def call_execute_transfer_tasks():
            return testutils.get_wrapped_function(self.server.execute_transfer_tasks)(
                self.server,
                mock.sentinel.context,
                mock.sentinel.transfer_id,
        ...
        mock_deepcopy.assert_called_once_with(mock_transfer.destination_environment)
        ...
        mock_check_execution_tasks_sanity.assert_called_once_with(
            mock_tasks_execution.return_value, mock_transfer.info
        )

        mock_add_transfer_tasks_execution.assert_called_once_with(
            mock.sentinel.context, mock_tasks_execution.return_value
        )

        if any([has_origin_minion_pool, has_target_minion_pool]):
            mock_minion_manager_client.allocate_minion_machines_for_transfer.assert_called_once_with(
                mock.sentinel.context,
                mock_transfer,
            )
            mock_set_tasks_execution_status.assert_called_once_with(
        ...
        self.assertEqual(result, mock_get_transfer_tasks_execution.return_value)

    @mock.patch.object(db_api, "get_transfer_tasks_executions")
    def test_get_transfer_tasks_executions(self, mock_get_transfer_tasks_executions):
        ...
        self.assertEqual(mock_get_transfer_tasks_executions.return_value, result)
    ...
    def test_get_transfer_tasks_execution(self, mock_get_transfer_tasks_execution):
        result = testutils.get_wrapped_function(
        ...
        self.assertEqual(mock_get_transfer_tasks_execution.return_value, result)
        mock_get_transfer_tasks_execution.assert_called_once_with(
            mock.sentinel.context,
            mock.sentinel.transfer_id,
            mock.sentinel.execution_id,
    ...
    def test_delete_transfer_tasks_execution(
        self, mock_delete_transfer_tasks_execution, mock_get_transfer_tasks_execution
    ):
        ...
        mock_get_transfer_tasks_execution.assert_called_once_with(
            mock.sentinel.context, mock.sentinel.transfer_id, mock.sentinel.execution_id
        )
        mock_delete_transfer_tasks_execution.assert_called_once_with(
            mock.sentinel.context, mock.sentinel.execution_id
        )
    ...
    def test_cancel_transfer_tasks_execution(
        ...
        testutils.get_wrapped_function(self.server.cancel_transfer_tasks_execution)(
            self.server,
            mock.sentinel.context,
            mock.sentinel.transfer_id,
            mock.sentinel.execution_id,
    ...
    @mock.patch.object(db_api, 'get_transfer_tasks_execution')
    def test__get_transfer_tasks_execution(self, mock_get_transfer_tasks_execution):
    ...
    def test__get_transfer_tasks_execution_no_execution(
        self, mock_get_transfer_tasks_execution
    ):
    ...
    def test_get_transfers(self, mock_get_transfers):
        ...
        self.assertEqual(mock_get_transfers.return_value, result)
    ...
    def test_get_transfer(self, mock_get_transfer):
        ...
        self.assertEqual(mock_get_transfer.return_value, result)
        mock_get_transfer.assert_called_once_with(
            mock.sentinel.context,
            mock.sentinel.transfer_id,
            include_task_info=False,
    ...
    def test_delete_transfer(
        ...
        testutils.get_wrapped_function(self.server.delete_transfer)(
            self.server, mock.sentinel.context, mock.sentinel.transfer_id
        )
        mock_get_transfer.assert_called_once_with(
    ...
    def test_delete_transfer_disks(
        ...
        def call_delete_transfer_disks():
            return testutils.get_wrapped_function(self.server.delete_transfer_disks)(
                self.server,
                mock.sentinel.context,
        ...
        mock_transfer = mock.Mock(
            ...
            network_map=mock.sentinel.network_map,
            info={instance: instance for instance in instances},
        )
        ...
        mock_get_transfer.assert_called_once_with(
            mock.sentinel.context, mock.sentinel.transfer_id, include_task_info=True
        )
        mock_check_transfer_running_executions.assert_called_once_with(
            mock.sentinel.context, mock_transfer
        )
        ...
        mock_begin_tasks.assert_called_once_with(
            mock.sentinel.context, mock_transfer, mock_tasks_execution.return_value
        )
        mock_get_transfer_tasks_execution.assert_called_once_with(
            mock.sentinel.context,
            mock_transfer.id,
        ...
        self.assertRaises(exception.InvalidTransferState, call_delete_transfer_disks)
    ...
    def test_check_endpoints_same_destination_connection_info(self):
        origin_endpoint = mock.Mock()
        destination_endpoint = mock.Mock()
        origin_endpoint.connection_info = mock.sentinel.origin_endpoint_connection_info
    ...
    @mock.patch.object(
        server.ConductorServerEndpoint, '_create_reservation_for_transfer'
    )
    @mock.patch.object(server.ConductorServerEndpoint, '_check_minion_pools_for_action')
    ...
    def test_create_instances_transfer(
        ...
        mock_get_endpoint.assert_has_calls(
            [
                ...
                mock.call(mock.sentinel.context, mock.sentinel.destination_endpoint_id),
            ]
        )
    ...
    @ddt.unpack
    def test_normalize_user_scripts(self, user_scripts, instances, expected_result):

        try:
            with self.assertLogs('coriolis.conductor.rpc.server', level='WARN'):
                result = self.server._normalize_user_scripts(user_scripts, instances)
    ...
    def test_check_running_transfer_deployments(self, mock_get_transfer_deployments):
        deployment_1 = mock.Mock()
        deployment_2 = mock.Mock()
        deployment_1.executions = [mock.Mock()]
        deployment_1.executions[0].status = constants.EXECUTION_STATUS_COMPLETED
        deployment_2.executions = [mock.Mock()]
        deployment_2.executions[0].status = constants.EXECUTION_STATUS_ERROR
    ...
    def test_check_running_transfer_deployments_invalid_transfer_state(
        self, mock_get_transfer_deployments
    ):
        deployment_1 = mock.Mock()
        deployment_2 = mock.Mock()
        deployment_1.executions = [mock.Mock()]
        ...
        deployment_2.executions = [mock.Mock()]
        deployment_2.executions[0].status = constants.EXECUTION_STATUS_COMPLETED
        deployments = [deployment_1, deployment_2]
        mock_get_transfer_deployments.return_value = deployments
        self.assertRaises(
            exception.InvalidTransferState,
    ...
    def test_check_running_executions(self, mock_get_executions):
        ...
        self.server._check_running_executions(mock.sentinel.context, transfer)
    ...
    @mock.patch.object(
        server.ConductorServerEndpoint, '_check_running_transfer_deployments'
    )
    @mock.patch.object(server.ConductorServerEndpoint, '_check_running_executions')
    def test_check_transfer_running_executions(
        self, mock_check_running_executions, mock_check_running_transfer_deployments
    ):
        transfer = mock.Mock()
        self.server._check_transfer_running_executions(mock.sentinel.context, transfer)
    ...
    @mock.patch.object(server.ConductorServerEndpoint, '_get_last_transfer_execution')
    def test_check_transfer_deploy_ability(self, mock_get_last):
        ...
        self.server._check_transfer_deploy_ability(mock.sentinel.context, mock_transfer)
    ...
    @mock.patch.object(server.ConductorServerEndpoint, "get_available_providers")
    def test_get_provider_types(self, mock_get_available_providers):
        endpoint = mock.Mock()
        result = self.server._get_provider_types(mock.sentinel.context, endpoint)

        self.assertEqual(
            (mock_get_available_providers.return_value.get(endpoint.type)["types"]),
            result,
        )

        mock_get_available_providers.assert_called_once_with(mock.sentinel.context)
    ...
    @mock.patch.object(server.ConductorServerEndpoint, '_normalize_user_scripts')
    @mock.patch.object(server.ConductorServerEndpoint, '_validate_deployment_inputs')
    ...
    def test_deploy_transfer_instances(
        self,
        mock_get_deployment,
        mock_execute_deployment,
        mock_get_transfer,
        mock_add_deployment,
        mock_deployment_model,
        ...
        result = testutils.get_wrapped_function(self.server.deploy_transfer_instances)(
            self.server,
            mock.sentinel.ctxt,
            mock.sentinel.transfer_id,
            force=force,
        ...
        self.assertTrue(
            transfer_mock.destination_environment
            is not deployment.destination_environment
        )
        mock_normalize_user_scripts.assert_called_once_with(
            mock.sentinel.user_scripts, transfer_mock.instances
        )
        mock_get_transfer.assert_called_once_with(
            mock.sentinel.ctxt, mock.sentinel.transfer_id, include_task_info=True
        )
        mock_add_deployment.assert_called_once_with(mock.sentinel.ctxt, deployment)
        mock_execute_deployment.assert_called_once_with(
            mock.sentinel.ctxt, deployment, False
        )
        mock_get_deployment.assert_called_once_with(mock.sentinel.ctxt, deployment.id)
    ...
    def test_deploy_transfer_instances_wait_for_execution(
        ...
        self.assertEqual(transfer_mock.skip_os_morphing, deployment.skip_os_morphing)
        self.assertEqual(
            transfer_mock.instance_osmorphing_minion_pool_mappings,
            deployment.instance_osmorphing_minion_pool_mappings,
        )
    ...
    def test_get_instance_scripts(self):
        user_scripts = {
    ...
    def test_get_instance_scripts_no_instance_script(self):
        user_scripts = {
            "global": 'mock_user_scripts',
            "instances": {
        ...
        expected_result = {'global': 'mock_user_scripts', 'instances': {}}
        result = self.server._get_instance_scripts(
            user_scripts, mock.sentinel.instance_1
        )
        self.assertEqual(expected_result, result)

    def test_get_instance_scripts_no_user_scripts(self):
        user_scripts = None
    ...
    @mock.patch.object(server.ConductorServerEndpoint, "_minion_manager_client")
    def test_deallocate_minion_machines_for_action(self, mock_minion_manager_client):
        action = mock.Mock()
        result = self.server._deallocate_minion_machines_for_action(
            mock.sentinel.context, action
        )

        self.assertEqual(
            (
                mock_minion_manager_client.deallocate_minion_machines_for_action.return_value
            ),
            result,
        )
        (
            mock_minion_manager_client.deallocate_minion_machines_for_action.assert_called_once_with(
                mock.sentinel.context, action.base_id
            )
        )

    @mock.patch.object(server.ConductorServerEndpoint, "_minion_manager_client")
    def test_check_minion_pools_for_action(self, mock_minion_manager_client):
        action = mock.Mock()
        self.server._check_minion_pools_for_action(mock.sentinel.context, action)

        (
            mock_minion_manager_client.validate_minion_pool_selections_for_action.assert_called_once_with(
                mock.sentinel.context, action
            )
        )
    ...
    def test_update_task_info_for_minion_allocations(
        self, mock_update_transfer_action_info_for_instance
    ):
        action = mock.Mock()
        ...
        action.info = {
            ...
            mock.sentinel.instance2: {
                'origin_minion_machine_id': mock.sentinel.origin_minion_id,
                'origin_minion_provider_properties': mock.sentinel.origin_minion_provider_properties,
                'origin_minion_connection_info': mock.sentinel.origin_minion_connection_info,
                'destination_minion_machine_id': mock.sentinel.destination_minion_id,
                'destination_minion_provider_properties': mock.sentinel.destination_minion_provider_properties,
                'destination_minion_connection_info': mock.sentinel.destination_minion_connection_info,
                'destination_minion_backup_writer_connection_info': mock.sentinel.destination_minion_backup_writer_connection_info,
                'osmorphing_minion_machine_id': mock.sentinel.osmorphing_minion_id,
                'osmorphing_minion_provider_properties': mock.sentinel.osmorphing_minion_provider_properties,
        ...
        minion_machine_allocations = {
            mock.sentinel.instance1: {
                'origin_minion': {
                    ...
                    "provider_properties": mock.sentinel.updated_origin_minion_provider_properties,
                    "connection_info": mock.sentinel.updated_origin_minion_connection_info,
                },
                'destination_minion': {
                    ...
                    "backup_writer_connection_info": (
                        mock.sentinel.updated_destination_minion_backup_writer_connection_info
                    ),
                },
                'osmorphing_minion': {
                    ...
                    "connection_info": mock.sentinel.updated_osmorphing_minion_connection_info,
                },
            },
        }
        ...
        expected_action_info = {
            mock.sentinel.instance1: {
                'origin_minion_machine_id': mock.sentinel.updated_origin_minion_id,
                'origin_minion_provider_properties': mock.sentinel.updated_origin_minion_provider_properties,
                'origin_minion_connection_info': mock.sentinel.updated_origin_minion_connection_info,
                'destination_minion_machine_id': mock.sentinel.updated_destination_minion_id,
                ...
                'osmorphing_minion_machine_id': mock.sentinel.updated_osmorphing_minion_id,
                'osmorphing_minion_provider_properties': mock.sentinel.updated_osmorphing_minion_provider_properties,
                'osmorphing_minion_connection_info': mock.sentinel.updated_osmorphing_minion_connection_info,
            },
        }
    ...
    @mock.patch.object(server.ConductorServerEndpoint, '_get_deployment')
    def test_get_execution_for_deployment(self, mock_get_deployment):
        ...
        result = self.server._get_execution_for_deployment(
            mock.sentinel.context, deployment, requery=False
        )
        self.assertEqual(execution1, result)
    ...
    @mock.patch.object(db_api, 'get_transfer_tasks_execution')
    @mock.patch.object(
        server.ConductorServerEndpoint, '_update_task_info_for_minion_allocations'
    )
    @mock.patch.object(server.ConductorServerEndpoint, '_get_last_transfer_execution')
    @mock.patch.object(server.ConductorServerEndpoint, '_get_transfer')
    def test_confirm_transfer_minions_allocation(
        ...
        testutils.get_wrapped_function(self.server.confirm_transfer_minions_allocation)(
            self.server,
            mock.sentinel.context,
            mock.sentinel.transfer_id,
        ...
        mock_get_last_transfer_execution.assert_called_once_with(
            mock.sentinel.context, mock_get_transfer.return_value.id
        )
    ...
    @mock.patch.object(server.ConductorServerEndpoint, '_get_execution_for_deployment')
    @mock.patch.object(server.ConductorServerEndpoint, '_get_deployment')
    def test_confirm_deployment_minions_allocation(
        ...
        mock_get_execution_for_deployment.assert_called_once_with(
            mock.sentinel.context, mock_get_deployment.return_value, requery=False
        )
        mock_update_task_info_for_minion_allocations.assert_called_once_with(
            mock.sentinel.context,
    ...
    def test_cancel_tasks_execution_no_config(
        ...
        call_cancel_tasks_execution()
        mock_worker_client.return_value.cancel_task.assert_called_once_with(
            mock.sentinel.context,
        ...
        mock_set_task_status.reset_mock()
        mock_worker_client.return_value.cancel_task.side_effect = Exception()
        call_cancel_tasks_execution()
    ...
    def test__get_deployment(self, mock_get_deployment):
    ...
    def test_cancel_tasks_execution(
        ...
        depends_on = config.get('depends_on') and [mock.sentinel.depends_on]
        execution = mock.Mock(
            id=mock.sentinel.execution_id,
    ...
    @mock.patch.object(
        server.ConductorServerEndpoint, '_deallocate_minion_machines_for_action'
    )
    ...
    def test_set_tasks_execution_status(
        ...
        def call_set_tasks_execution_status(new_execution_status):
            self.server._set_tasks_execution_status(
                context, execution, new_execution_status
            )
        ...
        mock_set_execution_status.assert_called_once_with(
            context, execution.id, constants.EXECUTION_STATUS_COMPLETED
        )
        mock_delete_trust.assert_called_once_with(context)
        ...
        mock_set_execution_status.assert_called_once_with(
            context, execution.id, constants.EXECUTION_STATUS_CANCELED
        )
        mock_delete_trust.assert_not_called()
        mock_get_action.assert_called_once_with(context, execution.action_id)
    ...
    def test_set_task_host(
        ...
        def call_set_task_host():
            testutils.get_wrapped_function(self.server.set_task_host)(
                self.server,
                mock.sentinel.context,
        ...
        self.assertRaises(exception.TaskIsCancelling, call_set_task_host)

        mock_get_task.return_value.status = (
            constants.TASK_STATUS_CANCELLING_AFTER_COMPLETION
        )
        call_set_task_host()
        mock_set_task_host_properties.assert_called_once_with(
            mock.sentinel.context, mock.sentinel.task_id, host=mock.sentinel.host
        )
        mock_set_task_status.assert_called_once_with(
            mock.sentinel.context,
            mock.sentinel.task_id,
    ...
    def test_set_task_process(
        ...
        def call_set_task_host():
            testutils.get_wrapped_function(self.server.set_task_process)(
                self.server,
                mock.sentinel.context,
                mock.sentinel.task_id,
        ...
        with self.assertRaisesRegex(exception.InvalidTaskState, "expected statuses"):
            call_set_task_host()
        ...
        with self.assertRaisesRegex(exception.InvalidTaskState, "has no host"):
            call_set_task_host()
    ...
    def test_check_clean_execution_deadlock(
        ...
        self.assertEqual(determined_state, constants.EXECUTION_STATUS_RUNNING)
        ...
        self.assertEqual(determined_state, constants.EXECUTION_STATUS_DEADLOCKED)
    ...
    def test_get_execution_status_no_config(
        ...
        self.assertEqual(status, constants.EXECUTION_STATUS_COMPLETED)

    @ddt.file_data("data/get_execution_status_config.yml")
    @ddt.unpack
    def test_get_execution_status(self, config, expected_status):
        tasks = config.get('tasks', [])
        execution = mock.Mock(
            id=mock.sentinel.execution_id,
            tasks=[
    ...
    @mock.patch.object(server.ConductorServerEndpoint, '_set_tasks_execution_status')
    @mock.patch.object(server.ConductorServerEndpoint, '_get_execution_status')
    @mock.patch.object(server.ConductorServerEndpoint, '_cancel_tasks_execution')
    @mock.patch.object(
        server.ConductorServerEndpoint, '_get_worker_service_rpc_for_task'
    )
    ...
    @mock.patch.object(server.ConductorServerEndpoint, '_get_task_origin')
    @mock.patch.object(
        server.ConductorServerEndpoint, '_check_clean_execution_deadlock'
    )
    @mock.patch.object(db_api, 'get_tasks_execution')
    def test_advance_execution_state_no_config(
        ...
        # call with no tasks
        with self.assertRaisesRegex(
            exception.InvalidActionTasksExecutionState, "no tasks"
        ):
        ...
        mock_get_task_origin.assert_called_once_with(
            mock.sentinel.context, execution.action
        )
        ...
        mock_check_clean_execution_deadlock.return_value = (
            constants.EXECUTION_STATUS_DEADLOCKED
        )
        ...
        mock_get_action.return_value = mock.Mock(info=task_info)
        started_tasks = call_advance_execution_state()
        mock_get_worker_service_rpc_for_task.assert_called_once_with(
            mock.sentinel.context,
            task,
        ...
        mock_get_worker_service_rpc_for_task.side_effect = CoriolisTestException()
        self.assertRaises(
            CoriolisTestException,
            call_advance_execution_state,
        )
    ...
    def test_advance_execution_state_scheduled_tasks(
        ...
        self.assertEqual(
            ...
            [
                ...
                and t['expected_status'] == constants.TASK_STATUS_PENDING
            ],
        )
    ...
    @mock.patch.object(server.ConductorServerEndpoint, '_update_transfer_volumes_info')
    ...
    def test_update_volumes_info_for_deployment_parent_transfer(
        ...
        mock_get_deployment.assert_called_once_with(
            mock.sentinel.context, mock.sentinel.deployment_id
        )
    ...
    def test_handle_post_task_actions(
        ...
        # no volumes_info
        mock_update_volumes_info_for_deployment_parent_transfer.assert_not_called()
        ...
        call_handle_post_task_actions()
        mock_update_volumes_info_for_deployment_parent_transfer.assert_called_once_with(
            mock.sentinel.context,
            mock.sentinel.action_id,
            mock.sentinel.instance,
        ...
        task.task_type = constants.TASK_TYPE_DELETE_TRANSFER_TARGET_DISK_SNAPSHOTS
        call_handle_post_task_actions()
        # no clone_disks, reset volumes_info
        mock_update_volumes_info_for_deployment_parent_transfer.assert_called_with(
            mock.sentinel.context,
            mock.sentinel.action_id,
            mock.sentinel.instance,
            {"volumes_info": []},
        ...
        for task_type in types:
            ...
            mock_validate_value.assert_called_once_with(
                task_info['transfer_result'], schemas.CORIOLIS_VM_EXPORT_INFO_SCHEMA
            )
        ...
        mock_update_transfer.assert_called_once_with(
            mock.sentinel.context, mock.sentinel.action_id, task_info
        )
        ...
        for task_type in types:
            ...
            mock_update_minion_machine.assert_called_once_with(
                ...
                {'provider_properties': [{'minion_provider_properties': 'value'}]},
            )
        ...
        call_handle_post_task_actions()
        mock_minion_manager_client.deallocate_minion_machine.assert_called_once_with(
            mock.sentinel.context,
            task_info['origin_minion_machine_id'],
        )
        ...
        task_info['destination_minion_machine_id'] = ['minion_machine_id']
        call_handle_post_task_actions()
        mock_minion_manager_client.deallocate_minion_machine.assert_not_called()
        mock_minion_manager_client.deallocate_minion_machine.reset_mock()
    ...
    def test_task_completed(
        ...
        mock_get_tasks_execution.return_value = mock.Mock(
            ...
            tasks=[
                mock.Mock(
                    id=mock.sentinel.task_id, status=constants.TASK_STATUS_COMPLETED
                )
            ],
        )
        ...
        # no task result
        self.server.task_completed(mock.sentinel.context, mock.sentinel.task_id, None)
        mock_update_transfer_action_info.assert_not_called()
        self.assertEqual(2, mock_get_action.call_count)

    @mock.patch.object(db_api, 'set_task_status')
    def test_cancel_execution_for_osmorphing_debugging(self, mock_set_task_status):
        subtask = mock.Mock()
        execution = mock.Mock()
        ...
        self.server._cancel_execution_for_osmorphing_debugging(
            mock.sentinel.context, execution
        )
        mock_set_task_status.assert_not_called()
    ...
    @mock.patch.object(server.ConductorServerEndpoint, "_advance_execution_state")
    @mock.patch.object(db_api, "get_tasks_execution")
    @mock.patch.object(db_api, "set_task_status")
    @mock.patch.object(db_api, "get_task")
    ...
    @mock.patch.object(server.ConductorServerEndpoint, "_set_tasks_execution_status")
    @mock.patch.object(
        server.ConductorServerEndpoint, "_cancel_execution_for_osmorphing_debugging"
    )
    @mock.patch.object(lockutils, "lock")
    @mock.patch.object(db_api, "get_action")
    @mock.patch.object(db_api, "get_tasks_execution")
    ...
    @mock.patch.object(db_api, "get_task")
    def test_add_task_event(self, mock_get_task, mock_add_task_event):
        task = mock.Mock()
        mock_get_task.return_value = task
        ...
        mock_get_task.assert_called_once_with(
            mock.sentinel.context, mock.sentinel.task_id
        )
    ...
    def test_add_task_progress_update(
        self, mock_get_task, mock_add_task_progress_update
    ):
        task = mock.Mock()
        mock_get_task.return_value = task
        task.status = constants.EXECUTION_STATUS_COMPLETED
        ...
        self.assertRaises(
            exception.InvalidTaskState,
            testutils.get_wrapped_function(self.server.add_task_progress_update),
            self.server,
            mock.sentinel.context,
            mock.sentinel.task_id,
            mock.sentinel.message,
        ...
        result = testutils.get_wrapped_function(self.server.add_task_progress_update)(
            self.server,
            mock.sentinel.context,
            mock.sentinel.task_id,
            mock.sentinel.message,
    ...
    def test_update_task_progress_update(self, mock_update_task_progress_update):
        testutils.get_wrapped_function(self.server.update_task_progress_update)(
            self.server,
            mock.sentinel.context,
            mock.sentinel.task_id,
    ...
    def test__get_transfer_schedule(self, mock_get_transfer_schedule):
        ...
        self.assertEqual(mock_get_transfer_schedule.return_value, result)
    ...
    def test_create_transfer_schedule(
        ...
        mock_add_transfer_schedule.assert_called_once_with(
            context, transfer_schedule, mock.ANY
        )
        mock_get_transfer_schedule.assert_called_once_with(
            context, mock.sentinel.transfer_id, transfer_schedule.id
        )

    @mock.patch.object(server.ConductorServerEndpoint, "_get_transfer_schedule")
    @mock.patch.object(db_api, "update_transfer_schedule")
    def test_update_transfer_schedule(
        self, mock_update_transfer_schedule, mock_get_transfer_schedule
    ):
        result = testutils.get_wrapped_function(self.server.update_transfer_schedule)(
            self.server,
            mock.sentinel.context,
            mock.sentinel.transfer_id,
            mock.sentinel.schedule_id,
    ...
    def test_cleanup_schedule_resources(
        ...
        self.server._cleanup_schedule_resources(mock.sentinel.context, schedule)

        mock_transfer_cron_client.unregister.assert_called_once_with(
            mock.sentinel.context, schedule
        )
        ...
        mock_get_admin_context.assert_called_once_with(trust_id=mock.sentinel.trust_id)
        mock_delete_trust.assert_called_once_with(mock_get_admin_context.return_value)

    @mock.patch.object(db_api, "delete_transfer_schedule")
    @mock.patch.object(server.ConductorServerEndpoint, "_get_transfer")
    def test_delete_transfer_schedule(
        self, mock_get_transfer, mock_delete_transfer_schedule
    ):
        transfer = mock.Mock()
    ...
    def test_get_transfer_schedules(self, mock_get_transfer_schedules):
        result = testutils.get_wrapped_function(self.server.get_transfer_schedules)(
            self.server, mock.sentinel.context, transfer_id=None, expired=True
        )

        self.assertEqual(mock_get_transfer_schedules.return_value, result)
        mock_get_transfer_schedules.assert_called_once_with(
            mock.sentinel.context, transfer_id=None, expired=True
        )

    @mock.patch.object(db_api, "get_transfer_schedule")
    def test_get_transfer_schedule(self, mock_get_transfer_schedule):
        result = testutils.get_wrapped_function(self.server.get_transfer_schedule)(
            self.server,
            mock.sentinel.context,
            mock.sentinel.transfer_id,
            mock.sentinel.schedule_id,
    ...
    def test_update_transfer(
        ...
        self.assertEqual(execution.action, mock_get_transfer.return_value)
        mock_check_execution_tasks_sanity.assert_called_once_with(
            execution, transfer.info
        )
        mock_add_transfer_tasks_execution.assert_called_once_with(
            mock.sentinel.context, execution
        )
        mock_begin_tasks.assert_called_once_with(
            mock.sentinel.context, transfer, execution
        )
        mock_get_transfer_tasks_execution.assert_called_once_with(
            mock.sentinel.context, mock.sentinel.transfer_id, execution.id
        )
        if has_updated_values:
            mock_check_minion_pools_for_action.assert_called_once_with(
                mock.sentinel.context, dummy
            )
        else:
        ...
        if has_transfer_instance:
            ...
            for instance in config['transfer'].get("info", {}):
                expected_sanitize_task_info_calls.append(mock.call(mock.ANY))
                expected_sanitize_task_info_calls.append(
                    mock.call(transfer.info[instance])
                )
                create_task_calls.append(
                    mock.call(
            ...
            mock_sanitize_task_info.assert_has_calls(expected_sanitize_task_info_calls)
    ...
    def test_create_region(self, mock_Region, mock_add_region, mock_get_region):
        ...
        self.assertEqual(mock_get_region.return_value, result)
        self.assertEqual(
            (
            ...
            (mock.sentinel.region_name, mock.sentinel.description, True),
        )
        mock_Region.assert_called_once()
        mock_add_region.assert_called_once_with(
            mock.sentinel.context, mock_Region.return_value
        )
        mock_get_region.assert_called_once_with(
            mock.sentinel.context, mock_Region.return_value.id
        )
    ...
    def test_get_regions(self, mock_get_regions):
        ...
        self.assertEqual(mock_get_regions.return_value, result)
    ...
    def test_get_region(self, mock_get_region):
        result = testutils.get_wrapped_function(self.server.get_region)(
    ...
    def test_update_region(self, mock_update_region, mock_get_region):
        result = testutils.get_wrapped_function(self.server.update_region)(
            self.server,
            mock.sentinel.context,
            mock.sentinel.region_id,
            mock.sentinel.updated_values,
        ...
        mock_update_region.assert_called_once_with(
            mock.sentinel.context, mock.sentinel.region_id, mock.sentinel.updated_values
        )
        mock_get_region.assert_called_once_with(
            mock.sentinel.context, mock.sentinel.region_id
        )
    ...
    def test_register_service(
        ...
        self.assertEqual(mock_get_service.return_value, result)
        self.assertEqual(
            (
        ...
        mock_add_service.assert_called_once_with(
            mock.sentinel.context, mock_Service.return_value
        )
        ...
        self.assertEqual(
            (mock_Service.return_value.providers, mock_Service.return_value.specs),
            (
        ...
        mock_get_service_status.assert_called_once_with(mock.sentinel.context)
        mock_update_service.assert_called_once_with(
            mock.sentinel.context,
            mock_Service.return_value.id,
            {"mapped_regions": mock.sentinel.mapped_regions},
    ...
    def test_check_service_registered(self, mock_find_service):
        ...
        self.assertEqual(mock_find_service.return_value, result)
        mock_find_service.assert_called_once_with(
            mock.sentinel.context,
            mock.sentinel.host,
            mock.sentinel.binary,
    ...
    def test_refresh_service_status(
        self, mock_get_service, mock_get_service_status, mock_update_service
    ):
        result = testutils.get_wrapped_function(self.server.refresh_service_status)(
            self.server,
            mock.sentinel.context,
        ...
        mock_get_service.assert_has_calls(
            [mock.call(mock.sentinel.context, mock.sentinel.service_id)] * 2
        )
        mock_get_service_status.assert_called_once_with(mock.sentinel.context)
        mock_update_service.assert_called_once_with(
            mock.sentinel.context,
    ...
    def test_get_services(self, mock_get_services):
        ...
        self.assertEqual(mock_get_services.return_value, result)
        mock_get_services.assert_called_once_with(mock.sentinel.context)

    @mock.patch.object(db_api, "get_service")
    def test_get_service(self, mock_get_service):
        result = testutils.get_wrapped_function(self.server.get_service)(
            self.server, mock.sentinel.context, mock.sentinel.service_id
        )
    ...
    @mock.patch.object(db_api, "get_service")
    @mock.patch.object(db_api, "update_service")
    def test_update_service(self, mock_update_service, mock_get_service):
        result = testutils.get_wrapped_function(self.server.update_service)(
            self.server,
            mock.sentinel.context,
            mock.sentinel.service_id,
            mock.sentinel.updated_values,
