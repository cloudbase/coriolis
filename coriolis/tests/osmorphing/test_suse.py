...
from coriolis.osmorphing import base, suse
...
class BaseSUSEMorphingToolsTestCase(test_base.CoriolisBaseTestCase):
    ...
    def test_get_required_detected_os_info_fields(self):
        result = suse.BaseSUSEMorphingTools.get_required_detected_os_info_fields()
    ...
    def test_check_os_supported(self):
        result = suse.BaseSUSEMorphingTools.check_os_supported(self.detected_os_info)

        self.assertTrue(result)

    def test_check_os_supported_opensuse_tumbleweed(self):
        self.detected_os_info['distribution_name'] = suse.OPENSUSE_DISTRO_IDENTIFIER
        self.detected_os_info['release_version'] = (
    ...
    def test__get_grub2_cfg_location_uefi(self, mock_test_path_chroot):
        ...
        mock_test_path_chroot.assert_called_once_with('/boot/efi/EFI/suse/grub.cfg')
    ...
    def test__run_mkinitrd_success(self, mock_exec_cmd_chroot):
        ...
        mock_exec_cmd_chroot.assert_called_once_with("mkinitrd")
    ...
    @mock.patch.object(suse.BaseSUSEMorphingTools, '_run_mkinitrd')
    @mock.patch.object(suse.BaseSUSEMorphingTools, '_run_dracut')
    def test__rebuild_initrds_old_version(self, mock_run_dracut, mock_run_mkinitrd):
        self.morphing_tools._rebuild_initrds()
    ...
    def test__enable_sles_module(self, mock_exec_cmd_chroot):
        ...
        mock_exec_cmd_chroot.assert_has_calls(
            [
                ...
                mock.call('SUSEConnect -p %s' % 'module2'),
    ...
    def test__enable_sles_module_with_exception(self, mock_exec_cmd_chroot):
        mock_exec_cmd_chroot.side_effect = ["module output", None, None, Exception()]
    ...
    def test_add_cloud_tools_repo(self, mock_add_repo):
        ...
        expected_repo = suse.CLOUD_TOOLS_REPO_URI_FORMAT % ('test_release', '_12')
    ...
    def test_add_cloud_tools_repo_with_tumbleweed_version(self, mock_add_repo):
        self.morphing_tools._version = suse.OPENSUSE_TUMBLEWEED_VERSION_IDENTIFIER
    ...
    def test__get_repos(self, mock_exec_cmd_chroot):
        ...
        expected_result = {'repo1': 'http://repo1.com', 'repo2': 'http://repo2.com'}
        self.assertEqual(result, expected_result)

    @mock.patch.object(base.BaseLinuxOSMorphingTools, '_exec_cmd_chroot')
    @mock.patch.object(suse.BaseSUSEMorphingTools, '_get_repos')
    def test__add_repo_existing_same_uri(self, mock_get_repos, mock_exec_cmd_chroot):
    ...
    @mock.patch.object(base.BaseLinuxOSMorphingTools, '_exec_cmd_chroot')
    @mock.patch.object(suse.BaseSUSEMorphingTools, '_get_repos')
    def test__add_repo_new(self, mock_get_repos, mock_exec_cmd_chroot, mock_uuid4):
    ...
    @mock.patch.object(base.BaseLinuxOSMorphingTools, '_exec_cmd_chroot')
    @mock.patch.object(suse.BaseSUSEMorphingTools, '_get_repos')
    def test__add_repo_with_exception(self, mock_get_repos, mock_exec_cmd_chroot):
        mock_exec_cmd_chroot.side_effect = Exception()
    ...
    def test_pre_packages_install_sles_old_version(
        self, mock_super_pre, mock_get_sle_modules, mock_enable_sles_module
    ):
    ...
    def test_pre_packages_install_opensuse(
        self, mock_super_pre, mock_enable_sles_module, mock_add_cloud_tools_repo
    ):
    ...
    def test__ifcfg_class_attributes(self):
        self.assertEqual(
            "etc/sysconfig/network", self.morphing_tools._NETWORK_SCRIPTS_PATH
        )
        self.assertEqual(suse.SUSE_IFCFG_TEMPLATE, self.morphing_tools._IFCFG_TEMPLATE)
    ...
    def test__write_nic_configs(
        ...
        mock_write_file_sudo.assert_has_calls(
            [
                mock.call("etc/sysconfig/network/ifcfg-eth0", suse.SUSE_IFCFG_TEMPLATE),
                mock.call("etc/sysconfig/network/ifcfg-eth1", suse.SUSE_IFCFG_TEMPLATE),
            ]
        )
    ...
    @mock.patch.object(suse.BaseSUSEMorphingTools, 'disable_predictable_nic_names')
    @mock.patch.object(suse.BaseSUSEMorphingTools, '_write_nic_configs')
    @mock.patch.object(suse.BaseSUSEMorphingTools, '_write_nmconnection_configs')
    @mock.patch.object(
