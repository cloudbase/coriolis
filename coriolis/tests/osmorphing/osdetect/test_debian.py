...
from coriolis.osmorphing.osdetect import base, debian
...
class DebianOSDetectToolsTestCase(test_base.CoriolisBaseTestCase):
    ...
    def test_detect_os(self, mock_read_file, mock_read_config_file, mock_test_path):
    ...
    def test_detect_os_debian_version(
        ...
        mock_test_path.assert_has_calls(
            [mock.call("etc/lsb-release"), mock.call("etc/debian_version")]
        )
    ...
    @mock.patch.object(base.BaseLinuxOSDetectTools, '_read_file')
    @mock.patch.object(base.BaseLinuxOSDetectTools, '_test_path')
    def test_detect_os_no_release(
        self, mock_test_path, mock_read_file, mock_read_config_file
    ):
