...
from coriolis.osmorphing.osdetect import base, manager
...
class MockOSDetectTool(base.BaseOSDetectTools):
    ...
    def detect_os(self):
        return {'os_type': 'mock_os_type', 'os_version': 'mock_os_version'}
...
class ManagerTestCase(test_base.CoriolisBaseTestCase):
    ...
    def test_check_custom_os_detect_tools_not_list(self):
        self.assertRaises(
            exception.InvalidCustomOSDetectTools,
            manager._check_custom_os_detect_tools,
            "not a list",
        )
    ...
    def test_detect_os_custom_tools(self, mock_check_custom_tools):
        ...
        expected_result = {'os_type': 'mock_os_type', 'os_version': 'mock_os_version'}
    ...
    def test_detect_os_invalid_os_type(self):
        ...
        self.assertRaises(
            exception.OSDetectToolsNotFound,
            manager.detect_os,
            self.conn,
            self.os_type,
            self.os_root_dir,
    ...
    def test_detect_os_no_detected_info(
        self,
        mock_oracle_detect_os,
        mock_centos_detect_os,
        mock_redhat_detect_os,
        mock_rocky_detect_os,
