...
class NmconnectionNetPreserverTestCase(test_base.CoriolisBaseTestCase):
    ...
    def test_check_net_preserver_True(
        self, mock_test_path, mock_get_nmconnection_files, mock_get_keyfiles_by_type
    ):
    ...
    @mock.patch.object(base.BaseLinuxOSMorphingTools, '_get_nmconnection_files')
    @mock.patch.object(base.BaseLinuxOSMorphingTools, '_test_path')
    def test_check_net_preserver_no_files(
    ...
    def test_parse_network(self, mock_get_keyfiles_by_type):
        ...
        nmconn_file_with_id = nmconnection_path + "/eth0.nmconnection"
        nmconn_with_id = {
            "id": "eth0",
            "mac-address": "00:11:22:33:44:55",
            "address1": "192.168.1.10/24",
        }
        nmconn_file_without_id = nmconnection_path + "/eth1.nmconnection"
        nmconn_without_id = {
            "mac-address": "AA:BB:CC:DD:EE:FF",
            "Address2": "192.168.1.20/24, 192.168.1.21/24",
        }
        nmconn_file_without_mac_address = nmconnection_path + "/eth2.nmconnection"
        ...
        nmconn_file_with_space = nmconnection_path + "/System ethx.nmconnection"
        ...
        expected_info = {
            ...
            "eth2": {"mac_address": None, "ip_addresses": ["192.168.1.30"]},
            "id_eth3": {"mac_address": None, "ip_addresses": ["192.168.1.40"]},
            "System_ethx": {"mac_address": None, "ip_addresses": ["192.168.1.50"]},
            "eth4": {"mac_address": None, "ip_addresses": ["192.168.1.60"]},
        }
