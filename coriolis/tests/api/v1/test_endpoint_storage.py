...
class EndpointStorageControllerTestCase(test_base.CoriolisBaseTestCase):
    ...
    def test_index(
        ...
        mock_context.can.assert_called_once_with('migration:endpoints:list_storage')
        ...
        self.assertEqual(mock_get_endpoint_storage.return_value, result)
    ...
    def test_index_no_env(
        ...
        mock_storage_collection.assert_called_once_with(mock_context, endpoint_id, {})
        mock_get_endpoint_storage.assert_called_once_with(
            mock_storage_collection.return_value
        )
        self.assertEqual(mock_get_endpoint_storage.return_value, result)
