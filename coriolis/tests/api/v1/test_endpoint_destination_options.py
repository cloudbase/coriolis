...
class EndpointDestinationOptionsControllerTestCase(test_base.CoriolisBaseTestCase):
    ...
    def test_index(
        ...
        self.assertEqual(mock_destination_options_collection.return_value, result)
