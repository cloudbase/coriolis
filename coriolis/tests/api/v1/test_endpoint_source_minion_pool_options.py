...
class EndpointSourceMinionPoolOptionsControllerTestCase(test_base.CoriolisBaseTestCase):
    """
    ...
    def setUp(self):
        ...
        self.endpoint_api = endpoint.EndpointSourceMinionPoolOptionsController()

    @mock.patch.object(utils, 'decode_base64_param')
    @mock.patch.object(endpoint_options_view, 'source_minion_pool_options_collection')
    ...
    def test_index(
        ...
        self.assertEqual(
            mock_source_minion_pool_options_collection.return_value, result
        )
