...
class UtilsTestCase(test_base.CoriolisBaseTestCase):
    ...
    def test_get_bool_url_arg_true(self, value):
        mock_req = mock.Mock()
    ...
    def test_get_bool_url_arg_false(self, value):
        mock_req = mock.Mock()
        mock_req.GET.get.return_value = value
        arg_name = "show_deleted"
    ...
    def test_get_bool_url_arg_invalid(self):
    ...
    def test_validate_network_map(self, mock_validate_value):
    ...
    def test_validate_network_map_schema_validation_exception(
        self, mock_validate_value
    ):
        network_map = "mock_network_map"
        mock_validate_value.side_effect = exception.SchemaValidationException()

        self.assertRaises(exc.HTTPBadRequest, utils.validate_network_map, network_map)
    ...
    @mock.patch.object(schemas, 'validate_value')
    def test_validate_storage_mappings(self, mock_validate_value):
    ...
    def test_validate_storage_mappings_schema_validation_exception(
        ...
        self.assertRaises(
            exc.HTTPBadRequest, utils.validate_storage_mappings, storage_mappings
        )
    ...
    @mock.patch.object(utils, '_build_keyerror_message')
    def test_format_keyerror_message_empty_keyerror(self, mock_build_keyerror_message):
    ...
    def test_build_keyerror_message_resource_not_equals_key(
        ...
        self.assertEqual(
            'The mock_resource update body lacks a required attribute: "mock_key"',
            result,
        )
    ...
    def test_validate_user_scripts(
        ...
        self.assertEqual(user_scripts, result)
    ...
    def test_validate_user_scripts_invalid_input(self, user_scripts):
        self.assertRaises(
            exception.InvalidInput, utils.validate_user_scripts, user_scripts
        )

    @ddt.file_data('data/utils_validate_instances_list_for_transfer.yml')
    def test_validate_instances_list_for_transfer(
        self, instances, expected_result, exception_raised
    ):
        if exception_raised:
            self.assertRaises(
