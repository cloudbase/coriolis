...
class EndpointControllerTestCase(test_base.CoriolisBaseTestCase):
    ...
    def test_show(
        ...
        mock_single.assert_called_once_with(mock_get_endpoint.return_value)
    ...
    def test_show_no_endpoint(
        ...
        self.assertRaises(exc.HTTPNotFound, self.endpoint_api.show, mock_req, id)
        mock_context.can.assert_called_once_with('migration:endpoints:show')
        mock_get_endpoint.assert_called_once_with(mock_context, id)
    ...
    def test_index(
        ...
        mock_collection.assert_called_once_with(mock_get_endpoints.return_value)
    ...
    def test__validate_create_body(self):
        ...
        self.assertEqual(
            ('mock_name', 'mock_type', None, 'mock_connection_info', []), endpoint
        )
    ...
    def test__validate_create_body_all_keys(self):
        ...
        self.assertEqual(
            (
                ...
                ['mapped_region_1', 'mapped_region_1'],
            ),
            endpoint,
        )
    ...
    def test__validate_create_body_no_endpoint(self):
        ...
        self.assertRaises(
            KeyError,
            testutils.get_wrapped_function(self.endpoint_api._validate_create_body),
            self.endpoint_api,
            body=mock_body,  # type: ignore
        )
    ...
    def test_create(self, mock__validate_create_body, mock_create, mock_single):
        mock_req = mock.Mock()
        mock_context = mock.Mock()
        mock_req.environ = {'coriolis.context': mock_context}
    ...
    def test__validate_update_body(self):
        ...
        self.assertEqual(mock_body['endpoint'], endpoint)
    ...
    def test__validate_update_body_no_endpoint(self):
        ...
        self.assertRaises(
            KeyError,
            testutils.get_wrapped_function(self.endpoint_api._validate_update_body),
            self.endpoint_api,
            body=mock_body,  # type: ignore
        )
    ...
    def test_update(self, mock__validate_update_body, mock_update, mock_single):
        mock_req = mock.Mock()
        mock_context = mock.Mock()
        mock_req.environ = {'coriolis.context': mock_context}
        id = mock.sentinel.id
        ...
        mock_update.assert_called_once_with(
            mock_context, id, mock__validate_update_body.return_value
        )
        self.assertEqual(mock_single.return_value, result)
    ...
    def test_delete(self, mock_delete):
        ...
        self.assertRaises(exc.HTTPNoContent, self.endpoint_api.delete, mock_req, id)
    ...
    def test_delete_not_found(self, mock_delete):
        ...
        self.assertRaises(exc.HTTPNotFound, self.endpoint_api.delete, mock_req, id)
