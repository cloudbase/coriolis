...
def get_endpoints_policy_label(rule_label):
    return "%s:%s" % (ENDPOINTS_POLICY_PREFIX, rule_label)
...
ENDPOINTS_POLICY_DEFAULT_RULES = [
    ...
    policy.DocumentedRuleDefault(
        ...
        [{"path": "/endpoints/{endpoint_id}", "method": "GET"}],
    ),
    ...
    policy.DocumentedRuleDefault(
        ...
        [{"path": "/endpoints/{endpoint_id}", "method": "PUT"}],
    ),
    policy.DocumentedRuleDefault(
        get_endpoints_policy_label('delete'),
        ENDPOINTS_POLICY_DEFAULT_RULE,
        "Delete endpoint",
        [{"path": "/endpoints/{endpoint_id}", "method": "DELETE"}],
    ),
    policy.DocumentedRuleDefault(
    ...
    policy.DocumentedRuleDefault(
        ...
        [{"path": "/endpoints/{endpoint_id}/instances", "method": "GET"}],
    ),
    policy.DocumentedRuleDefault(
    ...
    policy.DocumentedRuleDefault(
        ...
        [
            {
                "path": ("/endpoints/{endpoint_id}/destination-minion-pool-options"),  # noqa
                "method": "GET",
            }
        ],
    ),
    policy.DocumentedRuleDefault(
        ...
        [{"path": "/endpoints/{endpoint_id}/inventory", "method": "GET"}],
    ),
]
