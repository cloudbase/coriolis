...
class APIRouter(api.APIRouter):
    ...
    def _setup_routes(self, mapper, ext_mgr):
        ...
        mapper.resource('provider', 'providers', controller=self.resources['providers'])
        ...
        mapper.resource(
            ...
            controller=(self.resources['endpoint_destination_minion_pool_options']),
        )
        ...
        self.resources['endpoint_instances'] = endpoint_instances.create_resource()
        mapper.resource(
            'instance',
        ...
        self.resources['endpoint_inventory'] = endpoint_inventory.create_resource()
        mapper.resource(
            'inventory',
        ...
        self.resources['endpoint_networks'] = endpoint_networks.create_resource()
        mapper.resource(
            'network',
        ...
        self.resources['endpoint_storage'] = endpoint_storage.create_resource()
        mapper.resource(
            'storage',
        ...
        self.resources['provider_schemas'] = provider_schemas.create_resource()
        mapper.resource(
            'provider_schemas',
        ...
        migration_path = '/{project_id}/transfers/{transfer_id}/executions/{id}'
        mapper.connect(
            'transfer_tasks_execution_actions',
            migration_path + '/actions',
            controller=self.resources['transfer_tasks_execution_actions'],
            action='action',
            conditions={'method': 'POST'},
        )
        ...
        mapper.resource(
            'diagnostics', 'diagnostics', controller=self.resources['diagnostics']
        )
