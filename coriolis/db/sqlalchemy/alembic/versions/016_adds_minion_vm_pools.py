...
def upgrade():
    ...
    tables.append(
        sqlalchemy.Table(
            ...
            sqlalchemy.Column("environment_options", sqlalchemy.Text, nullable=False),
            sqlalchemy.Column("os_type", sqlalchemy.String(255), nullable=False),
            sqlalchemy.Column("platform", sqlalchemy.String(255), nullable=True),
            sqlalchemy.Column(
                "status",
            ...
            sqlalchemy.Column("shared_resources", sqlalchemy.Text, nullable=True),
            sqlalchemy.Column('minimum_minions', sqlalchemy.Integer, nullable=False),
            sqlalchemy.Column('maximum_minions', sqlalchemy.Integer, nullable=False),
            sqlalchemy.Column(
                'minion_max_idle_time', sqlalchemy.Integer, nullable=False
            ),
            sqlalchemy.Column(
                'minion_retention_strategy', sqlalchemy.String(255), nullable=False
            ),
            mysql_engine="InnoDB",
            mysql_charset="utf8",
        )
    ...
    tables.append(
        sqlalchemy.Table(
            ...
            sqlalchemy.Column('allocated_action', sqlalchemy.String(36), nullable=True),
            ...
            sqlalchemy.Column('provider_properties', sqlalchemy.Text, nullable=True),
            mysql_engine="InnoDB",
            mysql_charset="utf8",
        )
    )
    ...
    tables.append(
        sqlalchemy.Table(
            ...
            sqlalchemy.Column("current_step", sqlalchemy.BigInteger, nullable=False),
    ...
    op.add_column("base_transfer_action", instance_osmorphing_minion_pool_mappings)
