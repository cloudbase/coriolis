...
def upgrade(migrate_engine):
    ...
    sqlalchemy.Table('replica', meta, autoload=True)
    ...
    replica_schedules = sqlalchemy.Table(
        ...
        sqlalchemy.Column(
            "replica_id",
            sqlalchemy.String(36),
            sqlalchemy.ForeignKey('replica.id'),
            nullable=False,
        ),
        ...
        sqlalchemy.Column(
            "shutdown_instance", sqlalchemy.Boolean, default=False, nullable=False
        ),
