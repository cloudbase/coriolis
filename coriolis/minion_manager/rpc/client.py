...
MINION_MANAGER_OPTS = [
    cfg.IntOpt(
        "minion_mananger_rpc_timeout",
        help="Number of seconds until RPC calls to the minion manager timeout.",
    )
]
...
class MinionManagerClient(rpc.BaseRPCClient):
    def __init__(self, timeout=None):
        ...
        super(MinionManagerClient, self).__init__(target, timeout=timeout)
    ...
    def validate_minion_pool_selections_for_action(self, ctxt, action):
        return self._call(
            ctxt, 'validate_minion_pool_selections_for_action', action=action
        )
    ...
    def deallocate_minion_machine(self, ctxt, minion_machine_id):
        return self._cast(
            ctxt, 'deallocate_minion_machine', minion_machine_id=minion_machine_id
        )
    ...
    def set_up_shared_minion_pool_resources(self, ctxt, minion_pool_id):
        return self._call(
            ctxt, "set_up_shared_minion_pool_resources", minion_pool_id=minion_pool_id
        )

    def tear_down_shared_minion_pool_resources(self, ctxt, minion_pool_id, force=False):
        return self._call(
            ctxt,
            "tear_down_shared_minion_pool_resources",
            minion_pool_id=minion_pool_id,
            force=force,
        )
    ...
    def refresh_minion_pool(self, ctxt, minion_pool_id):
        return self._call(ctxt, "refresh_minion_pool", minion_pool_id=minion_pool_id)

    def deallocate_minion_pool(self, ctxt, minion_pool_id, force=False):
        return self._call(
            ctxt, "deallocate_minion_pool", minion_pool_id=minion_pool_id, force=force
        )
